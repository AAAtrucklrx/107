...
DESIGN_SECTIONS: list[tuple[str, list]] = [
    ...
    ("五、技术难度", [
        ...
        "安全实践延伸到校外（负责任披露）：开发二课活动推荐板块时，团队对青春科大\"智慧团学\"平台进行"
        "接口测试，发现一处 personal 接口水平越权风险；团队未利用、未扩散，当日（2026-08-23）通过官方渠道"
        "向平台老师提交完整安全报告，校方两天内确认修复（2026-08-25 回复致谢）。""发现—负责任披露—协同修复"
        "的完整链路，体现了团队对校内系统的尊重与安全伦理自觉；"
        "这种意识同样贯穿小蜗本身的每一项防护设计。",
    ]),
    ("六、运行环境与演示", [
